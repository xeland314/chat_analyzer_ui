...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1369: (x0,x1) => x0.file(x1),
      _1370: x0 => x0.webkitGetAsEntry(),
      ...
      _1387: x0 => ({type: x0}),
      _1388: (x0,x1) => new Blob(x0,x1),
      _1389: (x0,x1) => x0.item(x1),
      _1390: () => new FileReader(),
      _1392: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1393: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1393(f,arguments.length,x0) }),
      _1394: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1395: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1395(f,arguments.length,x0) }),
      _1396: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1399: (x0,x1) => x0.removeChild(x1),
      _1403: Date.now,
      _1405: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1406: s => {
      ...
      _1441: Object.is,
      _1442: o => o instanceof Array,
      _1443: (a, i) => a.push(i),
      _1446: (a, l) => a.length = l,
      _1447: a => a.pop(),
      _1448: (a, i) => a.splice(i, 1),
      _1449: (a, s) => a.join(s),
      _1450: (a, s, e) => a.slice(s, e),
      _1453: a => a.length,
      _1455: (a, i) => a[i],
      _1456: (a, i, v) => a[i] = v,
      _1458: o => {
      ...
      _1459: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1461: o => o instanceof Uint8Array,
      _1462: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1463: o => o instanceof Int8Array,
      _1464: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1465: o => o instanceof Uint8ClampedArray,
      _1466: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1467: o => o instanceof Uint16Array,
      _1468: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1469: o => o instanceof Int16Array,
      _1470: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1471: o => o instanceof Uint32Array,
      _1472: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1473: o => o instanceof Int32Array,
      _1474: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1476: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1477: o => o instanceof Float32Array,
      _1478: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1479: o => o instanceof Float64Array,
      _1480: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1481: (t, s) => t.set(s),
      _1482: l => new DataView(new ArrayBuffer(l)),
      _1483: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1484: o => o.byteLength,
      _1485: o => o.buffer,
      _1486: o => o.byteOffset,
      _1487: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1488: (b, o) => new DataView(b, o),
      _1489: (b, o, l) => new DataView(b, o, l),
      _1490: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1491: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1492: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1493: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1494: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1495: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1496: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1497: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1498: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1499: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1500: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1501: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1504: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1505: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1506: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1507: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1508: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1509: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1522: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1523: (handle) => clearTimeout(handle),
      _1524: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1525: (handle) => clearInterval(handle),
      _1526: (c) =>
      ...
      _1544: o => o.length,
      _1546: (o, i) => o[i],
      _1547: f => f.dartFunction,
      _1548: () => ({}),
      _1549: () => [],
      _1551: () => globalThis,
      _1552: (constructor, args) => {
      ...
      _1554: (o, p) => o[p],
      _1555: (o, p, v) => o[p] = v,
      _1556: (o, m, a) => o[m].apply(o, a),
      _1558: o => String(o),
      _1559: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1560: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1560(f,arguments.length,x0) }),
      _1561: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1561(f,arguments.length,x0,x1) }),
      _1562: o => {
      ...
      _1563: o => [o],
      _1564: (o0, o1) => [o0, o1],
      _1565: (o0, o1, o2) => [o0, o1, o2],
      _1566: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1580: x0 => x0.index,
      _1582: x0 => x0.flags,
      _1583: x0 => x0.multiline,
      _1584: x0 => x0.ignoreCase,
      _1585: x0 => x0.unicode,
      _1586: x0 => x0.dotAll,
      _1587: (x0,x1) => { x0.lastIndex = x1 },
      _1588: (o, p) => p in o,
      _1589: (o, p) => o[p],
      ...
      _1607: (x0,x1) => x0.key(x1),
      _1608: x0 => x0.random(),
      _1609: (x0,x1) => x0.getRandomValues(x1),
      _1610: () => globalThis.crypto,
      _1611: () => globalThis.Math,
      _1621: Function.prototype.call.bind(Number.prototype.toString),
      _1622: Function.prototype.call.bind(BigInt.prototype.toString),
      _1623: Function.prototype.call.bind(Number.prototype.toString),
      _1624: (d, digits) => d.toFixed(digits),
      _1719: (x0,x1) => { x0.responseType = x1 },
      _1720: x0 => x0.response,
      _1780: (x0,x1) => { x0.draggable = x1 },
      _1796: x0 => x0.style,
      _2725: (x0,x1) => { x0.accept = x1 },
      _2739: x0 => x0.files,
      _2765: (x0,x1) => { x0.multiple = x1 },
      _2783: (x0,x1) => { x0.type = x1 },
      _3484: x0 => x0.items,
      _3487: (x0,x1) => x0[x1],
      _3491: x0 => x0.length,
      _3497: x0 => x0.dataTransfer,
      _3501: () => globalThis.window,
      _3563: x0 => x0.navigator,
      _3634: (x0,x1) => { x0.ondragenter = x1 },
      _3636: (x0,x1) => { x0.ondragleave = x1 },
      _3638: (x0,x1) => { x0.ondragover = x1 },
      _3642: (x0,x1) => { x0.ondrop = x1 },
      _3827: x0 => x0.localStorage,
      _3950: x0 => x0.userAgent,
      _3951: x0 => x0.vendor,
      _4158: x0 => x0.length,
      _6062: x0 => x0.type,
      _6165: x0 => x0.firstChild,
      _6176: () => globalThis.document,
      _6591: (x0,x1) => { x0.id = x1 },
      _6618: x0 => x0.children,
      _6924: x0 => x0.clientX,
      _6925: x0 => x0.clientY,
      _8120: x0 => x0.size,
      _8121: x0 => x0.type,
      _8127: x0 => x0.name,
      _8128: x0 => x0.lastModified,
      _8133: x0 => x0.length,
      _8138: x0 => x0.result,
      _11048: (x0,x1) => { x0.display = x1 },
      _12955: x0 => x0.isDirectory,
      _12956: x0 => x0.name,
      _12957: x0 => x0.fullPath,
